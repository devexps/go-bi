...
const (
	ReportService_PostReport_FullMethodName = "/agent_service.v1.ReportService/PostReport"
)
...
type ReportServiceClient interface {
	PostReport(ctx context.Context, in *PostReportRequest, opts ...grpc.CallOption) (*PostReportReply, error)
}
...
func (c *reportServiceClient) PostReport(ctx context.Context, in *PostReportRequest, opts ...grpc.CallOption) (*PostReportReply, error) {
	out := new(PostReportReply)
...
func (UnimplementedReportServiceServer) PostReport(context.Context, *PostReportRequest) (*PostReportReply, error) {
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agent_service.v1.ReportService",
	...
	Metadata: "agent_service/v1/agent.proto",
}
